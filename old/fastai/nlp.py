...
class ConcatTextDatasetFromDataFrames(torchtext.data.Dataset):
    ...
    @classmethod
    def splits(
        cls, train_df=None, val_df=None, test_df=None, keep_nones=False, **kwargs
    ):
        res = (
            cls(train_df, **kwargs),
            cls(val_df, **kwargs),
...
class LanguageModelData:
    ...
    def __init__(
        self, path, field, trn_ds, val_ds, test_ds, bs, bptt, backwards=False, **kwargs
    ):
    ...
    @classmethod
    def from_text_files(
        cls, path, field, train, validation, test=None, bs=64, bptt=70, **kwargs
    ):
