                ...
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            ...
                            nn.ReLU(),
                            nn.Conv2d(
                                128, 128, (3, 3), (1, 1), (1, 1), 1, 32, bias=False
                            ),
                            nn.BatchNorm2d(128),
                            nn.ReLU(),
                        ),
                ...
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            ...
                            nn.ReLU(),
                            nn.Conv2d(
                                256, 256, (3, 3), (2, 2), (1, 1), 1, 32, bias=False
                            ),
                            nn.BatchNorm2d(256),
                            nn.ReLU(),
                        ),
                ...
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            ...
                            nn.ReLU(),
                            nn.Conv2d(
                                256, 256, (3, 3), (1, 1), (1, 1), 1, 32, bias=False
                            ),
                            nn.BatchNorm2d(256),
                            nn.ReLU(),
                        ),
                ...
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            ...
                            nn.ReLU(),
                            nn.Conv2d(
                                512, 512, (3, 3), (2, 2), (1, 1), 1, 32, bias=False
                            ),
                            nn.BatchNorm2d(512),
                            nn.ReLU(),
                        ),
                ...
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            ...
                            nn.ReLU(),
                            nn.Conv2d(
                                512, 512, (3, 3), (1, 1), (1, 1), 1, 32, bias=False
                            ),
                            nn.BatchNorm2d(512),
                            nn.ReLU(),
                        ),
            ...
            nn.Sequential(  # Sequential,
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            nn.Conv2d(
                                1024, 1024, (1, 1), (1, 1), (0, 0), 1, 1, bias=False
                            ),
                            nn.BatchNorm2d(1024),
                            nn.ReLU(),
                            nn.Conv2d(
            ...
            nn.Sequential(  # Sequential,
                LambdaMap(
                    ...
                    nn.Sequential(  # Sequential,
                        nn.Sequential(  # Sequential,
                            nn.Conv2d(
                                2048, 1024, (1, 1), (1, 1), (0, 0), 1, 1, bias=False
                            ),
                            nn.BatchNorm2d(1024),
                            nn.ReLU(),
                            nn.Conv2d(
