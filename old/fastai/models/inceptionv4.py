...
def load_mixed_4a_7a(state_dict, name_pth, name_tf):
    load_conv2d(
        state_dict, name_pth + ".branch0.0", name_tf + "/Branch_0/Conv2d_0a_1x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch0.1", name_tf + "/Branch_0/Conv2d_1a_3x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1.0", name_tf + "/Branch_1/Conv2d_0a_1x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1.1", name_tf + "/Branch_1/Conv2d_0b_1x7"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1.2", name_tf + "/Branch_1/Conv2d_0c_7x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1.3", name_tf + "/Branch_1/Conv2d_1a_3x3"
    )
...
def load_mixed_5(state_dict, name_pth, name_tf):
    ...
    load_conv2d(
        state_dict, name_pth + ".branch1.1", name_tf + "/Branch_1/Conv2d_0b_3x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.0", name_tf + "/Branch_2/Conv2d_0a_1x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.1", name_tf + "/Branch_2/Conv2d_0b_3x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.2", name_tf + "/Branch_2/Conv2d_0c_3x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch3.1", name_tf + "/Branch_3/Conv2d_0b_1x1"
    )
...
def load_mixed_6(state_dict, name_pth, name_tf):
    ...
    load_conv2d(
        state_dict, name_pth + ".branch2.1", name_tf + "/Branch_2/Conv2d_0b_7x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.2", name_tf + "/Branch_2/Conv2d_0c_1x7"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.3", name_tf + "/Branch_2/Conv2d_0d_7x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2.4", name_tf + "/Branch_2/Conv2d_0e_1x7"
    )
    load_conv2d(
        state_dict, name_pth + ".branch3.1", name_tf + "/Branch_3/Conv2d_0b_1x1"
    )
...
def load_mixed_7(state_dict, name_pth, name_tf):
    load_conv2d(state_dict, name_pth + ".branch0", name_tf + "/Branch_0/Conv2d_0a_1x1")
    load_conv2d(
        state_dict, name_pth + ".branch1_0", name_tf + "/Branch_1/Conv2d_0a_1x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1_1a", name_tf + "/Branch_1/Conv2d_0b_1x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch1_1b", name_tf + "/Branch_1/Conv2d_0c_3x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2_0", name_tf + "/Branch_2/Conv2d_0a_1x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2_1", name_tf + "/Branch_2/Conv2d_0b_3x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2_2", name_tf + "/Branch_2/Conv2d_0c_1x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2_3a", name_tf + "/Branch_2/Conv2d_0d_1x3"
    )
    load_conv2d(
        state_dict, name_pth + ".branch2_3b", name_tf + "/Branch_2/Conv2d_0e_3x1"
    )
    load_conv2d(
        state_dict, name_pth + ".branch3.1", name_tf + "/Branch_3/Conv2d_0b_1x1"
    )
