...
class ImageDataBunch(DataBunch):
    ...
    def from_name_re(
        ...
        **kwargs,
        ...
        return cls.from_name_func(
            path, fnames, _get_label, valid_pct=valid_pct, **kwargs
        )
...
def download_images(
    ...
    parallel(
        partial(_download_image_inner, dest, timeout=timeout),
        urls,
...
class ImageList(ItemList):
    ...
    def open(self, fn):
        ...
        return open_image(
            fn, convert_mode=self.convert_mode, after_open=self.after_open
        )
...
class ObjectCategoryList(MultiCategoryList):
    ...
    def reconstruct(self, t, x):
        ...
        return ImageBBox.create(
            *x.size, bboxes, labels=labels, classes=self.classes, scale=False
        )
